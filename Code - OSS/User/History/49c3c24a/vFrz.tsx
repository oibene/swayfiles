...
import { useOutClick } from "./outsideClick";
...
export default function ModalBag(data: ModalBagProps) {
    ...
    const divRef = useOutClick(handleOutClick);
    ...
    return(
        <div  ref={divRef} className="absolute w-100 h-140 bg-light-gray font-noto outline-1 outline-dark-gray mt-2 mr-2 rounded-sm">
