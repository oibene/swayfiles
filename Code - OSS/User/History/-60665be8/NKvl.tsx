...
const search_svg = '/logos/search_small.svg'
    ...
    <div className="bg-light">
        ...
        <div className="flex mx-10 h-15 justify-between">
            ...
            <div className="grid grid-flow-col gap-4 content-center font-noto text-sm text-dark-gray">
                <a href="/search" className="hover:font-bold hover:underline underline-offset-4 decoration-red decoration-2" >Masculino</a> 
                <a href="/search" className="hover:font-bold hover:underline underline-offset-4 decoration-red decoration-2" >Feminino</a>
                <a href="/search" className="hover:font-bold hover:underline underline-offset-4 decoration-red decoration-2" >Kids</a>
            </div>

            <div className="content-center">
            <div className="flex">
                <div className="flex bg-light-gray w-40 h-5 rounded-2xl hover:border-1">
                    <img className="ml-2 h-3.5 w-3.5 mt-1" src={search_svg} alt=""/>
