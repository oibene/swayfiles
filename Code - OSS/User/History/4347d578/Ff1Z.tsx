                ...
                <div className="m-10">
                    ...
                    <div>
                        <p className="text-xl font-bold">
                            {(variant == 'edit') ? 'Crie Sua Conta' : 'aa'}
                        </p>

                        <p className={(variant == 'edit') ? "text-xs mt-2" : "hidden"}>
                    ...
                    <div className="flex my-10">
                        ...
                        <div className="w-45 h-45 ml-15 rounded-lg bg-gray"></div>

                    </div>

                    <div className="flex">
                        <div className={(variant == 'edit') ? "w-60" : "hidden"}>
                        ...
                        <div className="flex ml-25">
                            ...
                            <button className={(variant == 'edit') ? "hidden" :
                                "w-30 h-8 mt-4 bg-dark-gray rounded-sm content-center outline-none cursor-pointer"}>
