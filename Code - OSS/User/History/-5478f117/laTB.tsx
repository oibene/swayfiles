    ...
    return(
        <div className="flex m-10 font-noto text-dark-gray text-sm">
            ...
            <div className="w-120 h-145 bg-light">
                ...
                <div>
                    <button onClick={e => setComponent('DSC')}>Descrição</button>
                    <button onClick={e => setComponent('CMP')}>Composição</button>
                    <button onClick={e => setComponent('FRT')}>Frete</button>
                    <button onClick={e => setComponent('COM')}>Avaliações({comments_count})</button>
                </div>
