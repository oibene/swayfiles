...
export default function ProductPage(){
    ...
    const [component, setComponent] = useState("DESC")
    ...
    return(
        <div className="flex m-10 font-noto text-dark-gray text-sm">
            ...
            <div className="w-120 h-145 bg-light">
                ...
                <div>
                    <button onClick={e => setComponent('DESC')}>Descrição</button>
                    <button onClick={e => setComponent('DESC')}>Composição</button>
                    <button onClick={e => setComponent('DESC')}>Frete</button>
                    <button onClick={e => setComponent('DESC')}>Avaliações({comments_count})</button>
                </div>
