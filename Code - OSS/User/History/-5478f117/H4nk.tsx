            ...
            <div className="w-120 h-145 bg-light">
                ...
                <div className="flex m-4">
                    <button onClick={e => setComponent('DSC')}>
                        <p className={(component == 'DSC' ? "m-1 underline underline-offset-4 decoration-red decoration-2 cursor-pointer" :
                                                            "m-1 hover:font-bold cursor-pointer")}>
                            Descrição
                        </p>
                    </button>

                    <button onClick={e => setComponent('CMP')}>
                        <p className={(component == 'CMP' ? "m-1 underline underline-offset-4 decoration-red decoration-2 cursor-pointer" :
                                                            "m-1 hover:font-bold cursor-pointer")}>
                            Composição
                        </p>
                    </button>
                    ...
                    <button onClick={e => setComponent('FRT')}>
                        <p className={(component == 'FRT' ? "m-1 underline underline-offset-4 decoration-red decoration-2 cursor-pointer" :
                                                            "m-1 hover:font-bold cursor-pointer")}>
                            Frete
                        </p>
                    </button>
                    ...
                    <button onClick={e => setComponent('COM')}>
                        <p className={(component == 'COM' ? "m-1 underline underline-offset-4 decoration-red decoration-2 cursor-pointer" :
                                                            "m-1 hover:font-bold cursor-pointer")}>
